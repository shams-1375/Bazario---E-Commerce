        ...
        <div className='flex justify-center items-center min-h-screen bg-teal-50'>
            <Card className="w-full max-w-sm">
                ...
                <CardFooter className="flex-col gap-2">
                    <Button onClick={submitHandler} type="submit" className="w-full cursor-pointer bg-teal-700 hover:bg-teal-900">
                      {loading ? "Creating account..." : "Signup"  }  
                    </Button>
                    <p className='text-gray-800 text-sm' >Already have an account? <Link to={'/login'} className='hover:underline cursor:pointer text-teal-800'>Login</Link> </p>
                </CardFooter>
            </Card>
        </div>
    )
