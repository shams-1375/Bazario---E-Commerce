...
const AdminProduct = () => {
  ...
  let filteredProducts = products.filter((product) => product.productName.toLowerCase().includes(searchTerm.toLowerCase()) ||
          ...
          return <Card key={index} className="px-4">
            <div className='flex items-center justify-between'>
              <div className='flex gap-2 items-center'>
                <img
                  src={product.productImg?.[0]?.url || 'Logo.png'}
                  ...
                  <DialogContent className="sm:max-w-156.25 max-h-185 overflow-y-scroll">
                    ...
                    <div className='flex flex-col gap-2'>
                      ...
                      <div className='grid gap-3'>
                        <Label>Price</Label>
                        <Input name="productPrice" value={editProduct?.productPrice}
                          onChange={handleChange} required type='number' />
                      </div>
                      <div className='grid grid-cols-2 gap-4'>
                        <div className='grid gap-2'>
                          <Label>Brand</Label>
                          <Input name="brand" required type='text' value={editProduct?.brand}
                            onChange={handleChange} placeholder='Ex-Apple' />
                        </div>
                        <div className='grid gap-2'>
                          <Label>Category</Label>
                          <Input name="category" required type='text' value={editProduct?.category}
                            onChange={handleChange} placeholder='Ex-Mobile' />
                        </div>
                      </div>
                      <div className='grid gap-4'>
                        ...
                        <Textarea name='productDesc' value={editProduct?.productDesc}
                          onChange={handleChange} placeholder='Enter brief Description of Product' />
                      </div>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction onClick={() => deleteProduct(product._id)} >Continue</AlertDialogAction>
                    </AlertDialogFooter>
                  </AlertDialogContent>
                </AlertDialog>
